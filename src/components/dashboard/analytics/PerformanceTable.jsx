...
export default function PerformanceTable({ data, isLoading }) {
  ...
  return (
    <div className="glass rounded-lg overflow-hidden">
        ...
        <table className="w-full text-sm">
          <thead className="bg-slate-100 dark:bg-slate-700">
            <tr>
              ...
              <th className="px-4 py-3 text-right text-slate-600 dark:text-slate-300 font-semibold">
      ...
      <div className="px-4 py-3 border-t border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/70">
