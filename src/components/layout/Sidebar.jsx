...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-40 flex flex-col w-64 glass card-shadow border-r border-white/5 bg-navy-900/90">
      {/* Logo */}
      <div className="flex items-center gap-3 px-6 py-5 border-b border-white/5">
        ...
        <div>
          <p className="text-sm font-bold text-white leading-tight">Grupo GK</p>
